...
fn test_has77() {
    assert!(has77(&[1, 7, 7]));
    assert!(has77(&[1, 7, 1, 7]));
    assert!(!has77(&[1, 7, 1, 1, 7]));
}

#[test]
fn test_has12() {
    assert!(has12(&[1, 3, 2]));
    assert!(has12(&[1, 3, 2, 5]));
...
#[test]
fn test_triple_up() {
    assert!(triple_up(&[1, 4, 5, 6, 2]));
    assert!(triple_up(&[1, 2, 3]));
    assert!(!triple_up(&[1, 2, 4]));
}
